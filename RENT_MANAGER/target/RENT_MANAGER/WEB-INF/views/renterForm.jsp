...
<div class="container">
	...
	<form:form class="form-horizontal" method="post" modelAttribute="renterForm" action="${userActionUrl}">
		...
		<form:hidden path="renterId" />
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<form:input path="dob" class="form-control" id="dob" placeholder="dob" />
				</div>
			</div>
						<div class="form-group">
				<label class="col-sm-2 control-label">Aadhaar</label>
				<div class="col-sm-10">
					<form:input path="aadhaarNo" class="form-control" id="aadhaarNo" placeholder="aadhaarNo" />
				</div>
			</div>
						<div class="form-group">
				...
				<div class="col-sm-10">
					<form:input path="pincode" class="form-control" id="pincode" placeholder="pincode" />
				</div>
			</div>
						<div class="form-group">
				...
				<div class="col-sm-10">
					<form:input path="state" class="form-control" id="state" placeholder="state" />
				</div>
			</div>
